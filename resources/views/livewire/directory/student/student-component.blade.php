    ...
    <div id="wrapper">
     ...
     <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item ">
                    <a class="nav-link {{Route::CurrentrouteName() == 'directory.home' ? 'rounded bg-light text-dark' : ''}} " href="{{route('directory.home')}}">
                                                                    ...
                                                                    @if(isset($listofstudents) and count($listofstudents) > 0)
                                                                        @foreach ($listofstudents as $studentpersonaldata)
                                                                            <tr>
                                                                                ...
                                                                                <td>{{$studentpersonaldata->fathername ?? ''}}</td>
                                                                                <td>{{$studentpersonaldata->mothername ?? ''}}</td>
                                                                                <td>{{$studentpersonaldata->schoolname ?? ''}}</td>
