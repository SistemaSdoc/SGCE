            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item ">
                    <a wire:ignore  class="nav-link {{Route::Current()->getName() == 'directory.students' ? 'rounded bg-light text-dark' : ''}} " href="{{route('directory.students')}}" >
                        <i class="fas fa-fw fa-users {{Route::Current()->getName() == 'directory.students' ? 'text-dark' : ''}}"></i>
                        <span>Utlizizadores</span>
                    </a>
                </li>  
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <a style="text-decoration:none !important" href="{{route('admin.note.management')}}">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{isset($usersquantity) ? $usersquantity : ''}}</div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-users fa-3x text-black" style='color:#000000'></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
