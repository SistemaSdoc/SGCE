    ...
    <div id="wrapper">
     ...
     <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Nav Item - Dashboard -->
                <li class="nav-item ">
                    <a wire:ignore class="nav-link {{Route::currentrouteName() == 'admin.home' ? 'rounded bg-light text-dark' : ''}} " href="{{route('admin.home')}}">
                        <i class="{{Route::currentrouteName() == 'admin.home' ? 'text-dark' : ''}} fas fa-fw fa-home"></i>
                        <span>Início</span>
                    </a>
                </li>             
                
                <li class="nav-item ">
                    <a wire:ignore class="nav-link {{Route::Current()->getName() == 'admin.note.management' ? 'rounded bg-light text-dark' : ''}}" href="{{route("admin.note.management")}}">
                        <i class="{{Route::Current()->getName() == 'admin.note.management' ? 'text-dark' : ''}} fas fa-fw fa-chart-bar"></i>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class='row mb-3'>
                                                        ...
                                                        <div class="col-md-12 flex-wrap d-flex align-items-center ">
                                                         ...
                                                         <div class="col-md-3">
                                                            <select wire:change="allnotesofstudents" wire:model="courseofstudent" class='form-control'>
                                                                    ...
                                                                    @if(isset($allstudentnotes) && count($allstudentnotes) > 0)
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <div class="d-flex align-items-center">
                                                                                        ...
                                                                                        <button  wire:click='updatenote({{$note->noteid}})' class=" btn btn-sm btn-primary btn sm mx-1">
                                                                                        Salvar
                                                                                        </button>
